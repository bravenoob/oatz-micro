...
import { EnterpriseComponent } from 'app/entities/oatzSkill/enterprise/enterprise.component';
...
describe('Component Tests', () => {
  describe('Enterprise Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.enterprises[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
